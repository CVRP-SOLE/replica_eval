...
class SOLE(nn.Module):
    ...
    def forward(
        self, x, point2segment=None, raw_coordinates=None, clip_feat=None, guide=None, caption=None, caption_entity=None, is_eval=False
    ):  
        with torch.no_grad():
            batch_coords, batch_feats = ME.utils.sparse_collate(x.decomposed_coordinates, clip_feat)
    ...
    def mask_module(
        ...
        # TRICK FOR INFERENCE, has no meaning #
        open_cost = []
        ...
        if ret_attn_mask:
            ...
            if point2segment is not None:
                ...
                return (
                    cost,
                    open_cost, # TRICK FOR INFERENCE, has no meaning #
                    open_caption_cost, # TRICK FOR INFERENCE, has no meaning #
                    open_caption_entity_cost, # TRICK FOR INFERENCE, has no meaning #
